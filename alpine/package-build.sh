...
su - builder -s /bin/sh -c '
  ...
  if [ -f "/home/builder/.abuild/builder-6904805d.rsa.pub" ]; then
    cp /home/builder/.abuild/builder-6904805d.rsa.pub "/$REPODEST/packager.rsa.pub"
    echo "✓ Public key copied to /$REPODEST/packager.rsa.pub (architecture-independent)"
  else
