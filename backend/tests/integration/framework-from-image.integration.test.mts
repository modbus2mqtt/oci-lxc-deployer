...
describe("FrameworkFromImage - Integration Tests", () => {
  ...
  describe("getAnnotationsFromImage - ungemockt (localhost)", () => {
    ...
    testIfSkopeo(
      "should extract annotations from home-assistant image (GitHub Container Registry)",
      async () => {
    ...
    testIfSkopeo(
      "should extract annotations from mariadb image (Docker Hub)",
      async () => {
        const annotations = await FrameworkFromImage.getAnnotationsFromImage(
          localhostVEContext,
          "mariadb",
    ...
    testIfSkopeo(
      "should extract annotations from ghcr.io image (GitHub Container Registry)",
      async () => {
        const annotations = await FrameworkFromImage.getAnnotationsFromImage(
          localhostVEContext,
          "ghcr.io/home-assistant/home-assistant",
        ...
        expect(annotations.documentation).toBe(
          "https://www.home-assistant.io/docs/",
        );
        expect(annotations.source).toBe(
    ...
    testIfSkopeo(
      "should extract annotations from docker.io image (explicit Docker Hub)",
      async () => {
        const annotations = await FrameworkFromImage.getAnnotationsFromImage(
          localhostVEContext,
          "nodered/node-red",
