...
describe("TemplateProcessor - Parameters from skipped templates should not appear in unresolved parameters", () => {
  ...
  beforeAll(() => {
    ...
    const templatesDir = persistenceHelper.resolve(
      ...
      "test-skip-unresolved-app/templates",
    );
    ...
    const applicationJson = {
      ...
      installation: { post_start: ["set-parameters.json", "skipped-template.json"] },
    };
    persistenceHelper.writeJsonSync(
      Volume.JsonApplications,
      "test-skip-unresolved-app/application.json",
      applicationJson,
    );
    ...
    persistenceHelper.writeJsonSync(
      Volume.JsonApplications,
      "test-skip-unresolved-app/templates/set-parameters.json",
      ...
      parameters: [
        {
          ...
          required: true,
          description:
            "This parameter should NOT appear in unresolved parameters",
        },
        {
          id: "skipped_param2",
          ...
          required: false,
          description:
            "This parameter should also NOT appear in unresolved parameters",
        },
      ],
      commands: [
        {
    ...
    persistenceHelper.writeJsonSync(
      Volume.JsonApplications,
      "test-skip-unresolved-app/templates/skipped-template.json",
      skippedTemplate,
    );
  ...
  it("should include parameters from skipped templates when skip_if_property_set variable is NOT set", async () => {
    ...
    const templatesDir2 = persistenceHelper.resolve(
      Volume.JsonApplications,
      "test-skip-unresolved-app-2/templates",
    );
    ...
    const applicationJson2 = {
      ...
      description:
        "Test application for skipped template parameters - variable not set",
      installation: {
        post_start: [
    ...
    persistenceHelper.writeJsonSync(
      Volume.JsonApplications,
      "test-skip-unresolved-app-2/application.json",
      applicationJson2,
    );
    ...
    persistenceHelper.writeJsonSync(
      Volume.JsonApplications,
      "test-skip-unresolved-app-2/templates/set-parameters-no-myvariable.json",
      setParametersTemplateNoMyVariable,
    );
      ...
      parameters: [
        {
          ...
          required: true,
          description:
            "This parameter SHOULD appear in unresolved parameters because template is NOT skipped",
        },
      ],
      commands: [
        {
    ...
    persistenceHelper.writeJsonSync(
      Volume.JsonApplications,
      "test-skip-unresolved-app-2/templates/skip-if-property-set-template.json",
