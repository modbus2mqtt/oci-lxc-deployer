...
DOCKER_cloudflare_tunnel_TAG="${DOCKER_cloudflare_tunnel_TAG:-2026.6.0}" # cloudflare/cloudflared (remote-managed tunnel connector)
...
export OCI_proxvex_TAG OCI_gptwol_TAG OCI_node_red_TAG OCI_modbus2mqtt_TAG OCI_eclipse_mosquitto_TAG OCI_zigbee2mqtt_TAG OCI_esphome_TAG OCI_gitea_TAG
