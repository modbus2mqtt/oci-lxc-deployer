...
OCI_cloudflare_tunnel_TAG="${OCI_cloudflare_tunnel_TAG:-2026.6.0}" # cloudflare/cloudflared (distroless; remote-managed tunnel connector)
...
export OCI_zot_mirror_TAG OCI_playwright_TAG OCI_oauth2_proxy_testbed_TAG OCI_wolproxy_TAG OCI_cloudflare_tunnel_TAG
